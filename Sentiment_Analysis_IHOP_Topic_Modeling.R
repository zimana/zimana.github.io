#Sentiment_Analysis_IHOP_Topic_Modeling
#
...
a <- bind_tf_idf(tdm_tidy,term, document, count)
a
as.data.frame(a)
ggplot(a, aes(x = term, y = tf_idf)) + geom_bar(stat = "identity") + xlab("Terms") + ylab("tf-idf") + coord_flip() + theme(axis.text = element_text(size = 7))
#
